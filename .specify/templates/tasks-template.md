...
**Tests**: Tests are REQUIRED for all behavior changes and bug fixes. Include unit, integration, or contract tests as appropriate.
...
- [ ] T011 Define UX consistency checklist (design system + states + accessibility)
- [ ] T012 Define feature performance budgets and measurement approach
...
- [ ] T015 [P] [US1] Unit test for [component/service] in tests/unit/test_[name].py
...
- [ ] T022 [US1] Validate UX consistency (states + accessibility) for user story 1
- [ ] T023 [US1] Validate performance budget for user story 1
...
- [ ] T026 [P] [US2] Unit test for [component/service] in tests/unit/test_[name].py
...
- [ ] T031 [US2] Validate UX consistency (states + accessibility) for user story 2
- [ ] T032 [US2] Validate performance budget for user story 2
...
- [ ] T035 [P] [US3] Unit test for [component/service] in tests/unit/test_[name].py
...
- [ ] T039 [US3] Validate UX consistency (states + accessibility) for user story 3
- [ ] T040 [US3] Validate performance budget for user story 3
